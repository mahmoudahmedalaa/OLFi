...
export function FeaturesAccordion() {
    ...
    return (
        <section id="features" className="py-32 bg-gradient-to-b from-base-beige to-[#EAE9E2] text-base-dark border-t border-base-dark/5">
                        ...
                        <div className="flex flex-col gap-4">
                            {features.map((feature) => (
                                <button
                                    ...
                                    className={`text-left p-6 rounded-2xl transition-all duration-300 border-l-4 border ${activeFeature.id === feature.id
                                        ? 'bg-white border-l-brand-teal border-brand-teal/10 shadow-xl shadow-brand-teal/5 lg:-translate-y-1'
                                        : 'bg-transparent border-l-transparent border-base-dark/[0.06] hover:bg-white/50 hover:border-l-brand-teal/30'
                                        }`}
                                >
