...
| --- | --- | --- | --- |
| Done | Mobile release | Bump iOS TestFlight build number to `45` without changing bundle IDs, slug, schemes, or project IDs. | `app npm run check:ios-build` passed |
...
- Next iOS/TestFlight build number: `45`.
