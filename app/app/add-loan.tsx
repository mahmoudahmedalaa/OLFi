        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: theme.colors.bg }}>
            ...
            >
                ...
                >
                    ...
                    <View style={{ flexDirection: 'row', gap: 12 }}>
                        <View style={{ flex: 1 }}>
                            <Text style={labelStyle(theme)}>Profit Rate</Text>
                            {/* Input with % suffix */}
                            <View
                                style={{
                        ...
                        <View style={{ flex: 1 }}>
                            <View style={{ flexDirection: 'row', alignItems: 'center', gap: 4, marginBottom: 8 }}>
                                ...
                                >
                                    ...
                                    >
                                        The fixed amount you pay every month to your financial institution. You can find this on your bank statement or mobile banking app.
                                    </Text>
                                </Popover>
                                <TouchableOpacity
                                    ref={emiInfoRef}
