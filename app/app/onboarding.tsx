...
const slides: Slide[] = [
    {
        id: '1',
        icon: 'wallet-outline',
        title: 'Track Your Financing',
        description: 'Add your personal and auto financing in one place. See your total outstanding and monthly payments at a glance.',
    ...
    },
    {
        ...
        description: 'Our BuyOut engine compares your financing against offers from top UAE banks to find you the best savings.',
    ...
    },
    {
        ...
        description: 'Instantly see how much you can save each month and over the lifetime of your financing with detailed comparisons.',
        gradient: ['#6366F1', '#4F46E5'],
    },
    {
        id: '4',
        icon: 'shield-checkmark-outline',
        title: 'Sharia-Compliant Future',
        description: 'Your Path to a Debt-Free, Sharia-Compliant Future. No hidden fees. No compounding interest. Just clear, ethical finance.',
